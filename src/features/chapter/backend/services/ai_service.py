...
class ChapterAIService:
    ...
    async def generate_chapter_content(
        ...
        try:
            ...
            # 构建AI提示词（使用模板）
            volume_title = volume_outline.title if volume_outline else None
            volume_description = volume_outline.description if volume_outline else None
            chapter_title_val = chapter_outline.title if chapter_outline else chapter.title
            chapter_description = chapter_outline.description if chapter_outline else None
